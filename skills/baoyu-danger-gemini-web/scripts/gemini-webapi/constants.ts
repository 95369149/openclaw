...
export class Model {
  ...
  static readonly G_3_1_PRO_PREVIEW = new Model("gemini-3.1-pro-preview", {}, false);
  ...
  static from_dict(model_dict: { model_name?: unknown; model_header?: unknown }): Model {
    ...
    if (typeof model_dict.model_name !== "string" || !model_dict.model_name.trim()) {
      throw new Error(
        "When passing a custom model as a dictionary, 'model_name' must be a non-empty string.",
      );
    }
