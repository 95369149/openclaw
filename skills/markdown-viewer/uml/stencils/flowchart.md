...
Stencil library: `mxgraph.flowchart.*`
...
| `mxgraph.flowchart.off-page_reference`     |                 |
| `mxgraph.flowchart.on-page_reference`      |                 |
...
```plantuml
@startuml
mxgraph.flowchart.annotation_1 "Annotation" as annotation_1
@enduml
```
