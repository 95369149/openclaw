...
Stencil library: `mxgraph.cabinets.*`
...
| `mxgraph.cabinets.coverPlate`                                  |                 |
| `mxgraph.cabinets.dimension`                                   |                 |
| `mxgraph.cabinets.dimensionBottom`                             |                 |
...
```plantuml
@startuml
mxgraph.cabinets.cabinet "Cabinet" as cabinet
@enduml
```
