...
1. **松果先森** - Nana+Seedance提示词库
   - 1215个 Nano Banana 提示词+效果图，110个 Seedance 2.0 提示词
   - https://opennana.com/awesome-prompt

2. **YouMind** - 集成多模型+提示词导航
   - 10017个提示词，400+ Seedance 2.0 提示词
   - https://youmind.com/zh-CN/nano-ban

3. **aipromptnav** - 提示词导航站
   - https://aipromptnav.com

4. **Promptfill** - 提示词填空器
   - https://promptfill.tanshilong.com
...
- **ZHO大神**: github.com/ZHO-ZHO-ZHO
- **PicoTrex**: github.com/PicoTrex/Awesome（110个提示词）
- **松果先森**: github.com/songguoxs/gpt4
- **Jermic**: github.com/Jermic/awesome（1000+创作者，3000+作品+提示词）
